...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="<?= base_url(); ?>/themplate/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
        </div>
    ...
    <!-- PAGE PLUGINS -->
    <!-- jQuery Mapael -->
    <script src="<?= base_url(); ?>/themplate/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
    <script src="<?= base_url(); ?>/themplate/plugins/raphael/raphael.min.js"></script>
    <script src="<?= base_url(); ?>/themplate/plugins/jquery-mapael/jquery.mapael.min.js"></script>
    <script src="<?= base_url(); ?>/themplate/plugins/jquery-mapael/maps/usa_states.min.js"></script>
    <!-- ChartJS -->
