                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php $no = 1;
                                foreach ($AmbilSemuaDataJurusan as $key => $value) { ?>
                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $value['nama_jurusan'] ?></td>
                                        <td>
                                            <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ubah<?= $value['id_jurusan'] ?>">
                                                <i class="fas fa-edit"></i> Ubah
                                            </button>
                                            <button class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $value['id_jurusan'] ?>">
...
<div class="modal fade" id="tambah">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('Superadmin/TambahDataJurusan') ?>
            <?= csrf_field() ?>
    ...
    <div class="modal fade" id="ubah<?= $value['id_jurusan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <?php echo form_open('Superadmin/UbahDataJurusan/' . $value['id_jurusan']) ?>
                <?= csrf_field() ?>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nama <?= $subtitle; ?></label>
                        <input name="nama_jurusan" value="<?= $value['nama_jurusan'] ?>" class="form-control" placeholder="Nama Jurusan" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-dismiss="modal">Batal</button>
    ...
    <div class="modal fade" id="hapus<?= $value['id_jurusan'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah Anda Ingin Menghapus <b><?= $subtitle; ?> <?= $value['nama_jurusan'] ?></b> ?
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-outline-danger btn-sm" data-dismiss="modal">Batal</button>
                    <a href="<?= base_url('superadmin/HapusDataJurusan/' . $value['id_jurusan']) ?>" class="btn btn-primary btn-sm">Hapus</a>
                </div>
            </div>
        </div>
    </div>
